        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                ...
                                .requestMatchers("/api/v1/insumos/**").permitAll()
                                .requestMatchers("/api/v1/insumo/**").permitAll()
                                .requestMatchers("/api/v1/egreso/**").permitAll()
                                .requestMatchers("/api/v1/egresos-page/**").permitAll()
